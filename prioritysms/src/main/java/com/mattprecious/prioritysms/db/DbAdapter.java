...
public class DbAdapter {
  ...
  private static final String JOIN_QUERY =
      String.format("%1$s LEFT OUTER JOIN %3$s ON (%1$s.%2$s = %3$s.%4$s)",
          DbHelper.PROFILES_TABLE_NAME, DbHelper.PROFILES_KEY_ID, DbHelper.SMS_PROFILES_TABLE_NAME,
  ...
  public List<SmsProfile> getEnabledSmsProfiles() {
    ...
    try {
      ...
      Cursor c =
          builder.query(db, null, selection, selectionArgs, null, null, DbHelper.PROFILES_KEY_NAME);
  ...
  private BaseProfile cursorToProfile(Cursor c) {
    ...
    // if SMS profile
    if (DbHelper.TYPE_ENUM_SMS.equals(c.getString(c.getColumnIndex(DbHelper.PROFILES_KEY_TYPE)))) {
  ...
  private void fillContactLookups(BaseProfile profile) {
    ...
    try {
      ...
      Cursor c =
          db.query(DbHelper.CONTACTS_TABLE_NAME, null, selection, selectionArgs, null, null, null);
  ...
  private void fillKeywords(SmsProfile profile) {
    ...
    try {
      ...
      Cursor c =
          db.query(DbHelper.KEYWORDS_TABLE_NAME, null, selection, selectionArgs, null, null, null);
  ...
  private static class DbHelper extends SQLiteOpenHelper {
    ...
    private static final String PROFILES_TABLE_CREATE = String.format("" +
        ...
        PROFILES_TABLE_NAME, PROFILES_KEY_ID, PROFILES_KEY_NAME, PROFILES_KEY_TYPE, TYPE_TABLE_NAME,
        TYPE_KEY_TYPE, PROFILES_KEY_ENABLED, PROFILES_KEY_ACTION_TYPE, ACTION_TYPE_TABLE_NAME,
        ACTION_TYPE_KEY_TYPE, PROFILES_KEY_RINGTONE, PROFILES_KEY_OVERRIDE_SILENT,
    ...
    private static final String SMS_PROFILES_TABLE_CREATE = String.format("" +
        ...
        SMS_PROFILES_TABLE_NAME, SMS_PROFILES_KEY_PROFILE_ID, PROFILES_TABLE_NAME, PROFILES_KEY_ID,
    ...
    private static final String CONTACTS_TABLE_CREATE = String.format("" +
        ...
        CONTACTS_TABLE_NAME, CONTACTS_KEY_PROFILE_ID, PROFILES_TABLE_NAME, PROFILES_KEY_ID,
    ...
    private static final String KEYWORDS_TABLE_CREATE = String.format("" +
        ...
        KEYWORDS_TABLE_NAME, KEYWORDS_KEY_PROFILE_ID, PROFILES_TABLE_NAME, PROFILES_KEY_ID,
    ...
    private static final String TYPE_TABLE_POPULATE = String.format("" +
        ...
        TYPE_TABLE_NAME, TYPE_ENUM_SMS, TYPE_KEY_TYPE, TYPE_KEY_NUM, TYPE_ENUM_PHONE
    );
    ...
    private static final String ACTION_TYPE_TABLE_POPULATE = String.format("" +
        ...
        ACTION_TYPE_TABLE_NAME, ACTION_TYPE_ENUM_ALARM, ACTION_TYPE_KEY_TYPE, ACTION_TYPE_KEY_NUM,
    ...
    private static final String METHOD_TABLE_POPULATE = String.format("" +
        ...
        METHOD_TABLE_NAME, METHOD_ENUM_ALL, METHOD_KEY_METHOD, METHOD_KEY_NUM, METHOD_ENUM_ANY,
        METHOD_ENUM_ONLY
    );
